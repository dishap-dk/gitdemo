# prac
Shopping_Cart
The main objective of the Shopping Cart System is to manage the details of Cart, Orders, Customer, Category. It manages all the information about Cart, Products, Orders
